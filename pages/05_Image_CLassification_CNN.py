...
plot_image_121("cnn-fruit-classification-title-img", "Image_Classification")
...
plot_image_121("cnn-image-examples", "Image_Classification")
...
plot_image_121("cnn-baseline-accuracy-plot", "Image_Classification")
...
plot_image_121("cnn-dropout-accuracy-plot", "Image_Classification")
...
plot_image_121("cnn-augmentation-accuracy-plot", "Image_Classification")
...
plot_image_121("cnn-tuned-accuracy-plot", "Image_Classification")
...
plot_image_121("vgg16-architecture", "Image_Classification")
...
plot_image_121("cnn-vgg16-accuracy-plot", "Image_Classification")
...
# Deployment <a name="ml-deployment"></a>

We now have a model object, and the required pre-processing steps to use this model. When this is ready to launch we can aggregate the necessary images and pass them through, obtaining image classification.

Based on this, we can work with the client to discuss when to use the classification and how it'll benefit them in the future.

In the meantime, the client can use the UI below to find the prediction and probability score for an image. The model is deployed using API. The API is created using FastAPI which is hosted on Heroku. This serves as a backend server where models are loaded and served to make real-time predictions through HTTP requests.

In this section, we will use the 'Optimised Architecture + Dropout + Image Augmentation' model to make predictions. The model is deployed as an API, which serves as an end-point to make predictions. 

The prediction is made using the following code -
...
#### Please upload photos below to get the prediction -
