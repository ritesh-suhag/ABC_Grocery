...
# Title - 
st.markdown("""
            # Enhancing Customer Targeting Using ML

ABC grocery retailer wants to utilise Machine Learning to reduce mailing costs, and improve ROI!

""", unsafe_allow_html=True)

plot_image_121('classification-title-img', 'Enhancing Customer Targeting', [1,5,1])
...
ABC grocery retailer sent out mailers in a marketing campaign for their new *delivery club*.  This cost customers \$100 per year for membership, and offered free grocery deliveries, rather than the normal cost of $10 per delivery.
...
plot_image_121('log-reg-feature-selection-plot', 'Enhancing Customer Targeting')
...
plot_image_121('log-reg-confusion-matrix', 'Enhancing Customer Targeting')
...
plot_image_121('log-reg-optimal-threshold-plot', 'Enhancing Customer Targeting')
...
plot_image_121('clf-tree-confusion-matrix', 'Enhancing Customer Targeting')
...
plot_image_121('clf-tree-nodes-plot', 'Enhancing Customer Targeting')
...
plot_image_121('clf-tree-max-depth-plot', 'Enhancing Customer Targeting')
...
plot_image_121('rf-confusion-matrix', 'Enhancing Customer Targeting')
...
plot_image_121('rf-classification-feature-importance', 'Enhancing Customer Targeting')
st.write('')
plot_image_121('rf-classification-permutation-importance', 'Enhancing Customer Targeting')
...
plot_image_121('knn-feature-selection-plot', 'Enhancing Customer Targeting')
...
plot_image_121('knn-confusion-matrix', 'Enhancing Customer Targeting')
...
plot_image_121('knn-optimal-k-value-plot', 'Enhancing Customer Targeting')
