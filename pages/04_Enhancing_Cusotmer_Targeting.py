...
ABC grocery retailer hired a market research consultancy to append market level customer loyalty information to the database.  However, only around 50% of the client's customer base could be tagged, thus the other half did not have this information present.  Let's use ML to solve this!

> [Customer Loyalty, Machine Learning, Regression, Python]
""", unsafe_allow_html=True)

plot_image_121('regression-title-img', 'Predicting Customer Loyalty', [1,5,1])
...
plot_image_121('lin-reg-feature-selection-plot', 'Predicting Customer Loyalty')
...
plot_image_121('regression-tree-max-depth-plot', 'Predicting Customer Loyalty')
...
plot_image_121('regression-tree-nodes-plot', 'Predicting Customer Loyalty')
...
plot_image_121('rf-regression-feature-importance', 'Predicting Customer Loyalty')
st.write()
plot_image_121('rf-regression-permutation-importance', 'Predicting Customer Loyalty')
